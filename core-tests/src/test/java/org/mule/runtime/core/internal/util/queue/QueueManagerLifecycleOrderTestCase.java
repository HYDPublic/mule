...
public class QueueManagerLifecycleOrderTestCase extends AbstractMuleTestCase {
  ...
  public void before() throws InitialisationException, ConfigurationException {
    ...
    objects.put("_muleErrorTypeRepository", createDefaultErrorTypeRepository());
    objects.put(ProcessorInterceptorManager.REGISTRY_KEY, mock(ProcessorInterceptorManager.class));
